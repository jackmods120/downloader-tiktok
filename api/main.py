...
"ku": {
    ...
    "found"           : "📝 سەردێڕ: {title}\n👤 خاوەن: {owner}\n\n📊 ئامارەکان:\n👁 بینەر: {views}  \n❤️ لایک: {likes}  \n💬 کۆمێنت: {comments}\n\n🎬 <a href=\"https://t.me/TikTok_Downloader_Jack_Robot\">کلیک لێرە بکە — دابەزاندن دەستپێبکە</a>",
...
"en": {
    ...
    "found"           : "📝 Title: {title}\n👤 Author: {owner}\n\n📊 Stats:\n👁 Views: {views}  \n❤️ Likes: {likes}  \n💬 Comments: {comments}\n\n🎬 <a href=\"https://t.me/TikTok_Downloader_Jack_Robot\">Click Here — Start Downloading</a>",
...
"ar": {
    ...
    "found"           : "📝 العنوان: {title}\n👤 المالك: {owner}\n\n📊 الإحصائيات:\n👁 مشاهدة: {views}  \n❤️ إعجاب: {likes}  \n💬 تعليق: {comments}\n\n🎬 <a href=\"https://t.me/TikTok_Downloader_Jack_Robot\">اضغط هنا — ابدأ التحميل</a>",
